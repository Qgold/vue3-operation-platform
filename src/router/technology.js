...
export const technologyRoutes = [
     {
        path: "/tec",
        name:'technology',
        meta: { title: "ThreeD",icon:'ce-jijingongjuicon1',isMenu:true ,permission:'technology'},
        component: Layout,
        children: [
          {
          path: "/webAssembly",
          ...
          meta: { title: "WebAssemly",isMenu:true,permission:'technology:webAssembly' },
        },
         {
          path: "/3d",
          name: "3d",
          component: ()=>import("../views/ThreeD.vue"),
          meta: { title: "3D货架",isMenu:true,permission:'technology:3d'  },
        },
        // {
        //   path: "/react",
        //   name: "react",
